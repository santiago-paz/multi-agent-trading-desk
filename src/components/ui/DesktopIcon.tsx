...
export const DesktopIcon: React.FC<DesktopIconProps> = ({ 
  ...
  }, [id, isTracking, isDragging, onMove]);
  ...
  return (
    ...
    >
      <button
        ...
        style={{ minHeight: 52 }}
      >
        <div className="w-8 h-8 flex items-center justify-center shrink-0 overflow-hidden flex-shrink-0 pointer-events-none">
          {useImage ? (
            <img
              src={iconSrc}
              alt=""
        ...
        <span 
          ...
          style={{ textShadow: '0 0 1px #000, 1px 1px 1px #000', userSelect: 'none' }}
        >
          {label}
        </span>
      </button>
