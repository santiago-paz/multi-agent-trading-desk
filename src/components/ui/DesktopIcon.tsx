  ...
  return (
    ...
    >
      <button
        ...
        onClick={handleClick}
        className="desktop-icon flex flex-col items-center justify-start gap-0.5 w-[76px] p-1 bg-transparent border-none cursor-pointer text-left focus:outline-none focus-visible:outline-2 focus-visible:outline-dotted focus-visible:outline-white focus-visible:outline-offset-1 rounded-none min-h-0"
        style={{ minHeight: 52 }}
      >
        ...
        <span
          className="text-[11px] text-white text-center leading-tight font-normal max-w-full px-0.5 block pointer-events-none overflow-hidden"
          style={{
